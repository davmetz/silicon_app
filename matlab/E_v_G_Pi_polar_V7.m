...
%             1xn vector of Trans. piezoresitive coeff   E.piL(t,i) in Pa^-1 t: 1,2 for p- or n-type
    ...
    for p= 1:size(c,2) % 
        ...
        v= -(2*C.s(2)+s*(l(i)^2*l(j)^2+m(i)^2*m(j)^2+n(i)^2*n(j)^2))/...
